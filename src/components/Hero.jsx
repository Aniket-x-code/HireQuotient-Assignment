...
<div className={styles.navm}>
    ...
    <section class="sticky">
      ...
      >
        ...
        <h1
          class="font-bold leading-10 tracking-tight text-left mx-2 text-[#070505] text-center sm:leading-none text-2xl sm:text-7xl"
        >
      ...
      <div
        class="max-w-xl px-4 pb-14 mx-auto text-left md:max-w-none md:text-center"
      >
