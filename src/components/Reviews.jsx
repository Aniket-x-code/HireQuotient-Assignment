  ...
  return (
    <div class="mb-16">
            ...
            <dh-component>
                ...
                <div class="w-full bg-white mt-24 px-10 pt-10">
                    <div class="container mx-auto">
                        <div role="list"  aria-label="Behind the scenes People " class="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm hover:scale-110  transition duration-500 lg:w-2/5">
                                <div class="rounded overflow-hidden shadow-md bg-white">
                                    ...
                                    <div class="px-6 mt-16">
                                        ...
                                        <p class="text-center text-gray-600 text-base pt-3 font-normal">I can't imagine running my business without this product. The automation features have saved me hours of manual work, allowing me to focus on strategic tasks.</p>
                            ...
                            <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm hover:scale-110 transition duration-500 lg:w-2/5">
                                <div class="rounded overflow-hidden shadow-md bg-white">
                                    ...
                                    <div class="px-6 mt-16">
                                        ...
                                        <p class="text-center text-gray-600 text-base pt-3 font-normal">Using this product has been a game-changer for our team. The collaboration features and intuitive interface have greatly improved our productivity.</p>
                                        <div class="w-full flex justify-center pt-5 pb-5">
                                            <a href="javascript:void(0)" class="mx-5">
                                                <div aria-label="Github" role="img">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
                            ...
                            <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm hover:scale-110  transition duration-500 lg:w-2/5">
                                <div class="rounded overflow-hidden shadow-md bg-white">
                                    ...
                                    <div class="px-6 mt-16">
                                        ...
                                        <p class="text-center text-gray-600 text-base pt-3 font-normal">Manage Wise transformed our team's productivity. The intuitive interface and powerful features have made a significant impact on our daily operations"</p>
                                        <div class="w-full flex justify-center pt-5 pb-5">
                                            <a href="javascript:void(0)" class="mx-5">
                                                <div aria-label="Github" role="img">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
